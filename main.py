...
# --- VIA EXPRESSA (ROTEAMENTO AUTOMÁTICO) ---
# Se já tem o carimbo de autenticado, vai direto pro Terminal
if st.session_state.get("autenticado", False):
    st.switch_page("pages/0_Terminal.py")

# Esconder menu lateral na tela de login
st.markdown("""
    <style>
...
# --- FLUXO DA TELA DE LOGIN/CADASTRO ---
        ...
        if btn_login:
            if email_login and senha_login:
                try:
                    ...
                    st.switch_page("pages/0_Terminal.py") # TELETRANSPORTE IMEDIATO
                except Exception as e:
